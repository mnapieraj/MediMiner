...
(function($, undefined) {
	...
	this.regional[""] = { // Default regional settings
	    ...
	    monthNames : [ 'Styczeń', 'Luty', 'Marzec', 'Kwiecień', 'Maj',
		    ...
		    'Październik', 'Listopad', 'Grudzień' ], // Names of
								// months for
								// drop-down and
								// formatting
	    monthNamesShort : [ 'Sty', 'Lu', 'Mar', 'Kw', 'Maj', 'Cze', 'Lip',
		    'Sie', 'Wrz', 'Pa', 'Lis', 'Gru' ], // For formatting
		    dayNames: ['Niedziela','Poniedzialek','Wtorek','Środa','Czwartek','Piątek','Sobota'], // For formatting
		    dayNamesShort: ['Nie','Pn','Wt','Śr','Czw','Pt','So'], // For
										    // formatting
		    dayNamesMin: ['N','Pn','Wt','Śr','Cz','Pt','So'], // Column
									// headings
									// for
									// days
									// starting
